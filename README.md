...
The list and lock files are stored into `~/.config/pkglist`, and they will be generated when running the script if not already present.
...
- Make a copy of any of the `*-install.sh` scripts and rename it `apt-install.sh`.
